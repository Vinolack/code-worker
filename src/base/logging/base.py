...
from src.base.logging.default_logging_conf import (
    default_logging_conf,
    server_logging_retention,
    server_logging_rotation,
)
from src.base.utils.func_util import add_param_if_true


def setup_logging(
    log_dir: Optional[Union[str, Path]] = None,
    *,
    log_conf: Optional[dict[str, Any]] = None,
    sink: Optional[Union[str, Path]] = None,
    log_level: Optional[Union[str, int]] = None,
    console_log_level: Union[str, int] = logging.WARNING,
    log_format: Optional[str] = None,
    log_filter: Optional[Callable[..., bool]] = None,
    ...
    **kwargs,
    ...
    Args:
        ...
        console_log_level (Union[str, int]): 控制台输出的日志级别，默认为 logging.WARNING。
